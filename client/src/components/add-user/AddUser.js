        ...
        <Form onSubmit={handleSubmit}>
          <Form.Row>
            <Form.Group as={Col} md="4" controlId="name">
              ...
              <Form.Control
                type="text"
                value={name}
                placeholder="Mr. Binaya Chaudhary"
                onChange={onChange}
                required
              ></Form.Control>
            ...
            <Form.Group as={Col} md="4" controlId="email">
              ...
              <Form.Text className="text-muted">User Email is required.*</Form.Text>
            </Form.Group>
          </Form.Row>
          ...
          <Form.Row>
            ...
            <Form.Group as={Col} md="4" controlId="role">
              ...
              <Form.Text className="text-muted">User Role is required.*</Form.Text>
            </Form.Group>
          </Form.Row>
