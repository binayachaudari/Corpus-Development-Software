          ...
          <Form onSubmit={handleSubmit} className="pb-5">
            ...
            <Form.Row>
              <Form.Group as={Col} md="4" controlId="file_id" {...slideInAnimation(0.5)}>
                ...
                <Form.Text className="text-muted">Select filename to assign, required.*</Form.Text>
              </Form.Group>
            ...
            <Form.Row>
              <Form.Group as={Col} md="2" controlId="start_index" {...slideInAnimation(0.7)}>
                ...
                <Form.Control
                  type="number"
                  value={
                    translatedFiles && translatedFiles.find((obj) => obj._id === formData.file_id)
                      ? translatedFiles.find((obj) => obj._id === formData.file_id).start_index
                      : 0
                  }
                  readOnly
                />
              ...
              <Form.Group as={Col} md="2" controlId="end_index" {...slideInAnimation(0.8)}>
                ...
                <Form.Control
                  ...
                  value={
                    translatedFiles && translatedFiles.find((obj) => obj._id === formData.file_id)
                      ? translatedFiles.find((obj) => obj._id === formData.file_id).end_index
                      : 0
                  }
                  readOnly
                />
