...
const adminLinks = (pathname) => (
  <Nav className="mr-auto">
    <Nav.Link as={Link} to="/dashboard" {...slideInAnimation(0.3)} active={pathname === '/dashboard'}>Dashboard</Nav.Link>
    <Nav.Link as={Link} to="/assign-task" {...slideInAnimation(0.4)} active={pathname === '/assign-task'}>Assign Task</Nav.Link>
    <Nav.Link as={Link} to="/add-user" {...slideInAnimation(0.5)} active={pathname === '/add-user'}>Add User</Nav.Link>
    <Nav.Link as={Link} to="/users" {...slideInAnimation(0.6)} active={pathname === '/users'}>Users</Nav.Link>
  </Nav>
)
...
const linguistLinks = (pathname) => (
  < Nav className="mr-auto" >
    <Nav.Link as={Link} to="/dashboard" {...slideInAnimation(0.3)} active={pathname === '/dashboard'}>Dashboard</Nav.Link>
    <Nav.Link as={Link} to="/translate/assignments" {...slideInAnimation(0.4)} active={pathname === '/translate/assignments'}>Assignments</Nav.Link>
  </Nav >
)
...
const reviewerLinks = (pathname) => (
  < Nav className="mr-auto" >
    <Nav.Link as={Link} to="/dashboard" {...slideInAnimation(0.3)} active={pathname === '/dashboard'}>Dashboard</Nav.Link>
    <Nav.Link as={Link} to="/review/assignments" {...slideInAnimation(0.4)} active={pathname === '/review/assignments'}>Assignments</Nav.Link>
  </Nav >
)
