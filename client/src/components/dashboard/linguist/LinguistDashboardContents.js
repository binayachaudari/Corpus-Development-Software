      ...
      <Row className="mt-5">
        <Col sm={2}>
          <Nav variant="pills" className="flex-column  mb-5 sticky-top">
            <Nav.Item>
              <Nav.Link eventKey="translation_assigned_files" {...slideInAnimation(0.2)}>
                Translation Assigned
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="under_translation" {...slideInAnimation(0.4)}>
                Under Translation
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="translated" {...slideInAnimation(0.6)}>
                Translated
              </Nav.Link>
            </Nav.Item>
          </Nav>
        ...
        <Col className="text-justify" sm={10}>
          <Tab.Content>
            <Tab.Pane eventKey="translation_assigned_files" transition={false} {...slideInAnimation(0.3)}>
              <FileStatusComponent
                loadData={translationGetMyFiles}
