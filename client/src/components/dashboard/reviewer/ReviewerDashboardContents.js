      ...
      <Row className="mt-5">
        <Col sm={2}>
          <Nav variant="pills" className="flex-column  mb-5 sticky-top">
            <Nav.Item>
              <Nav.Link eventKey="review_assigned_files" {...slideInAnimation(0.2)}>
                Review Assigned
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="under_review" {...slideInAnimation(0.2)}>
                Under Review
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="reviewed" {...slideInAnimation(0.2)}>
                Reviewed
              </Nav.Link>
            </Nav.Item>
          </Nav>
