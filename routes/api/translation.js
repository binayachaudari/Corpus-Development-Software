...
router
  ...
  .post(
    ...
    isValidAssignment,
    translationTask.addTranslationTask
  );
...
router.route('/assignments').get(authenticateToken, checkRole.restrictTo('Linguist'), getFileDetails.getMyFiles);
